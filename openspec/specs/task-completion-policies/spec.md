...
Defines how the TaskEngine places a task after it completes — covering retry behavior on failure, cancellation handling, and the terminal placement dictated by `onFailurePolicy` and `onSuccessPolicy`.
