...
export const EngineTaskSchema = Schema.Struct({
  ...
  historyEnabled: BooleanFromBytes.pipe(Schema.optional),
  maxHistoryEntries: IntegerFromBytes.pipe(Schema.optional),
...
export const EngineTaskInsertSchema = Schema.Struct({
  ...
  historyEnabled: Schema.Boolean.pipe(Schema.optional),
  maxHistoryEntries: Schema.NullOr(Schema.Number).pipe(Schema.optional),
