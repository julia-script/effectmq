...
describe("deterministic queue-boundary faults", () => {
  test("retries safely around offer, acquire, heartbeat, ack, event, and cleanup", () =>
    Effect.gen(function* () {
      ...
      yield* engine.extendLock(prefix, "task", attempt.leaseToken, 10_000);
